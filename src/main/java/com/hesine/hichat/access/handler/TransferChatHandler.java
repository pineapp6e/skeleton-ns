...
public class TransferChatHandler extends SimpleChannelInboundHandler<ChatOperationRequest> {
    private static Logger logger = Logger.getLogger(TransferChatHandler.class);
    ...
    protected void channelRead0(ChannelHandlerContext ctx, ChatOperationRequest msg)
            throws Exception {
        logger.info("TransferChat Request : " + JSON.toJSONString(msg));

        int ret = chatOperationBO.transferChat(msg);
        ...
        logger.info("TransferChat Response : " + JSON.toJSONString(response));
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        ...
        FullHttpResponse res = new DefaultFullHttpResponse(HTTP_1_1, OK,
                Unpooled.wrappedBuffer(JSON.toJSONString(response).getBytes()));
        logger.info("TransferChat Exception Response : " + JSON.toJSONString(response));
